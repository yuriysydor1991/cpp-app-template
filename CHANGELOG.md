...
## [appQt60.10.0] - 2026-08-17

- 285e262 Introducing the InsertNewlineAtEOF clang-format option
- dc73ec0 Introducing the appCURLChatGPT branch info into the READMEs
- 39706bf Hiding the ApplicationContext fields and adding the atomic stop flag
- b43c210 Moving the linker hardening options out of the compile options
- d14f85c Adding the missing keyword to the real default logger link command
- a04a889 Split the DefaultLogger into a static proxy and a real logger instance
- 6f7f2a8 Introducing the appCURLClaude branch info into the READMEs
