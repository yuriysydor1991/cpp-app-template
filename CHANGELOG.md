...
## [appLZMA0.11.0] - 2026-08-17

- 19a11c7 Introducing the InsertNewlineAtEOF clang-format option
- c63d7e4 Introducing the appCURLChatGPT branch info into the READMEs
- 2b1e957 Hiding the ApplicationContext fields and adding the atomic stop flag
- 0ebc213 Moving the linker hardening options out of the compile options
- b126126 Split the DefaultLogger into a static proxy and a real logger instance
- 0813728 Introducing the appCURLClaude branch info into the READMEs
- 0e67914 Introducing the external documentation URLs check into the Jenkins pipeline
- b5e5746 Correcting the docker modules path of the documentation
- 2080448 Introducing the quick build and the docker starter scripts
- 6b1432f Introducing the quick build and the docker starter scripts
- 6d9b473 Making the docker containers run under unprivileged users
- 1b36502 Formatting the sources with the clang-format
- 004fa5c Repairing the pipeline code check stages
- f2f70f9 Introducing the appPGPLOT branch info into the READMEs
- f940673 Fixing the Jenkinsfile
- a9f62ce Fix broken cppcheck link in section 5 index
- d800d14 Fix Groovy escape sequences in markdown link checker stage
- bb5d996 Rework markdown link checker stage to pure bash
- 332d52b Add Jenkinsfile stage to detect broken markdown links; fix pre-existing broken links
- b7ca1f0 Reorganize doc/sections into section dirs with category grouping
- a22a6c2 Add an OpenSSL cmake enabler module with SHA-256, HMAC-SHA256 and HTTPS/TLS client code samples
- d8cef25 Register the missing tests in the misc/Jenkinsfile
- aa6019d Group the enabler documentation under subsections in the READMEs
- 114781b Group the compression branches under a dedicated README section
- 94869f5 Fixing the Jenkinsfile branch
- 1706683 Introduce the appLZMA branch: a liblzma compress/uncompress component
- 009ec72 Add a liblzma (XZ Utils) compression library enabler module
- 4d09d9e Introducing the appZlib branch info into the READMEs
