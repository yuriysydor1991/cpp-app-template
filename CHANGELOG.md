...
## [appZlib0.11.0] - 2026-08-17

- de8fba6 Introducing the InsertNewlineAtEOF clang-format option
- e556a58 Introducing the appCURLChatGPT branch info into the READMEs
- 734c342 Hiding the ApplicationContext fields and adding the atomic stop flag
- c7a862b Moving the linker hardening options out of the compile options
- 852be03 Split the DefaultLogger into a static proxy and a real logger instance
- 03253a8 Introducing the appCURLClaude branch info into the READMEs
- c8ad3ec Introducing the external documentation URLs check into the Jenkins pipeline
- 734d4bc Correcting the docker modules path of the documentation
- 465a9c1 Introducing the quick build and the docker starter scripts
- e854c42 Introducing the quick build and the docker starter scripts
- 5a6506d Making the docker containers run under unprivileged users
- 198731f Formatting the sources with the clang-format
- 64d1229 Repairing the pipeline code check stages
- 0c72bf1 Introducing the appPGPLOT branch info into the READMEs
- 28e956d Fixing the Jenkinsfile
- e0c6e98 Fix broken cppcheck link in section 5 index
- 2fbdc60 Fix Groovy escape sequences in markdown link checker stage
- 1836d36 Rework markdown link checker stage to pure bash
- cdd76ed Add Jenkinsfile stage to detect broken markdown links; fix pre-existing broken links
- 6b2c9b6 Reorganize doc/sections into section dirs with category grouping
- 50bbb79 Add an OpenSSL cmake enabler module with SHA-256, HMAC-SHA256 and HTTPS/TLS client code samples
- 91b26cc Register the missing tests in the misc/Jenkinsfile
- e4d8d93 Group the enabler documentation under subsections in the READMEs
- 5a35a92 Group the compression branches under a dedicated README section
- 171e6f6 Fix the misc/Jenkinsfile checkout branch to the appZlib branch name
- 95d3fbf Introducing the appLZMA branch info into the READMEs
- 69e1377 Add a liblzma (XZ Utils) compression library enabler module
- 7577dd3 Guard zlib compress_to_file against inputs that overflow uInt
- c9a1a2c Guard zlib compress/uncompress against inputs that overflow uInt
- 1989f61 Introducing the appZlib branch info into the READMEs
- 39d3ba1 Introduce the appZlib branch: a zlib compress/uncompress wrapper component
- 12fc3f0 Add zlib compression usage examples to its enabler documentation
- ce73cf5 Replace the redundant PROJECT_NAME CMake variable with CMAKE_PROJECT_NAME
- 66bc975 Introducing the appGtkmm4Vulkan branch info into the READMEs
- 6fb7cc3 Removing the appGtkmm4Vulkan branch info from the READMEs
- 058f46d Introducing the appQt6Vulkan and appGtkmm4Vulkan branches info into the READMEs
- c4bbdd0 Simplifying root CMakeLists.txt
- e327b1d Introducing the appFirebird branch info into the READMEs
- 916dca7 Introducing the appGtkmm4GDBusClient branch info into the READMEs
- 86a5303 Introducing the appQt6GLArea branch info into the READMEs
- 9a8c769 Introducing the appGtkmm4GLArea branch info into the READMEs
- 46e8b86 Splitting the Data Visualization README category into Plots/Graphs and Maps
- b678a2a Introducing the applibMeson branch info into the READMEs
- b4eafca Introducing the zlib and image format cmake enablers with docs
- 0c02f94 Introducing the appSFML branch info into the READMEs
- 17c3860 Introducing the appwxWidgets branch info into the READMEs
- 0a78d4c Introducing the appQt6QtDBusClient branch info into the READMEs
- d7805a9 Introducing the appQt6QtLocation branch info into the READMEs
- 21e2b90 Introducing the appQt6ChartView branch into the READMEs
- 15d6faf Introducing the appGtkmm4LeafLet and appQt6LeafLet branches info into the READMEs
- bc63397 Introducing the COMPONENTS arg for template_project_default_3rdparty_enabler
- ae04e6c Removing the SDL3 current marking
- f6e79ab Introducing information about the SDL3 branch in the READMEs
- d34a187 Replacing faulty SimpleLogger mention with the DefaultLogger
- b92df71 Removing faulty simple_logger mention in the log.h
- ecd1d16 Rename the simple logger to DefaultLogger and add top-level log.h tests
- a2e93cb Add template-specific packager, documentation and registration checks
- 451c989 Introducing the appSDBusCxxClient and appSDBusCxxServer branches info into the READMEs
- d118ec1 Moving Dockerfiles and packagers files into separate subdirs in the misc
- 75319c6 Adding .claude dir to .gitignore
