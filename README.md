...
```
git clone --branch appSDL2 https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appSDL2 https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
