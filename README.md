...
- `appQt6` branch at [appQt6](https://github.com/yuriysydor1991/cpp-app-template/tree/appQt6) (**поточна**) for the application general classes with additional defined structure for the Qt6 QML window application development.
