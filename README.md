...
```
git clone --branch appBoostLog https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appBoostLog https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
