...
- `appWinUI3` branch at [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appWinUI3), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appWinUI3)] (**current**) for the application general classes with additional defined structure for the [Microsoft WinUI 3](https://learn.microsoft.com/windows/apps/winui/winui3/) + [C++/WinRT](https://learn.microsoft.com/windows/uwp/cpp-and-winrt-apis/) Microsoft Windows desktop application development. This is a **Windows-only** branch: the GNU/Linux packagers (flatpak, snap, deb, rpm, FreeBSD pkg), the Docker integration and the Valgrind/gprof profilers were removed, the WIX (MSI) packager is kept, and the Jenkins pipeline targets a Windows agent. The platform-independent core still builds and is unit/component tested on any platform.
...
- `appOpenGameArtAudio` branch at [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appOpenGameArtAudio), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appOpenGameArtAudio)] with general application related classes to generate a single binary executable that keeps the curated [OpenGameArt](https://opengameart.org) sound packs fetched and intact, records the license of every pack in a manifest that travels into the binary, makes every sound of every pack reachable from the C++ code and writes the Qt ([.qrc](https://doc.qt.io/qt-6/resources.html)) and the Gtkmm ([GResource](https://docs.gtk.org/gio/struct.Resource.html)) manifests that embed the selected sounds into the application binary.

- `appFreesoundAudio` branch at [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appFreesoundAudio), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appFreesoundAudio)] with general application related classes to generate a single binary executable that keeps a curated selection of [Freesound](https://freesound.org) sounds fetched and intact, records the license and the source page of every single sound in a manifest that travels into the binary, makes every sound reachable from the C++ code and writes the Qt ([.qrc](https://doc.qt.io/qt-6/resources.html)) and the Gtkmm ([GResource](https://docs.gtk.org/gio/struct.Resource.html)) manifests that embed the selected sounds into the application binary.
...
1. [Project structure](/doc/sections/en_US/4-project-structure/4-project-structure.md)
    ...
    1. [WinUI 3 + C++/WinRT integration](/doc/sections/en_US/4-project-structure/4-8-winui3-cppwinrt-integration.md)
    ...
    1. [Handling the OS signals](/doc/sections/en_US/4-project-structure/4-8-handling-the-OS-signals.md)
...
1. [Project build](/doc/sections/en_US/5-project-build/5-project-build.md)
    ...
    1. Containers & CI
        1. [The GitHub Actions CI pipeline](/doc/sections/en_US/5-project-build/containers-ci/5-41-the-GitHub-Actions-CI-pipeline.md)
        1. [The GitLab CI/CD pipeline](/doc/sections/en_US/5-project-build/containers-ci/5-42-the-GitLab-CI-pipeline.md)
    1. Packagers
