...
- `appGtkmm3Glade` branch at [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appGtkmm3Glade), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appGtkmm3Glade)] (**current**) for the application general classes with additional defined structure for the C++ application development with [Gtkmm](https://gtkmm.gnome.org/en/index.html)-3.0 and [Glade](https://en.wikipedia.org/wiki/Glade_Interface_Designer) application with XML UI creation.
...
1. [Project structure](/doc/sections/en_US/4-project-structure/4-project-structure.md)
    ...
    1. [UI Implementation](/doc/sections/en_US/4-project-structure/4-8-gtkmm3glade-ui-implementation.md)
    1. [Resource embedding](/doc/sections/en_US/4-project-structure/4-6-gtkmm3glade-resource-embedding.md)
    ...
    1. [The toolkit messages](/doc/sections/en_US/4-project-structure/4-9-the-toolkit-messages.md)
