...
- `appGtkmm3` branch at [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appGtkmm3), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appGtkmm3)] (**current**) for the application general classes with additional defined structure for the Gtkmm-3.0 with C++ window application development.
...
```
git clone --branch appGtkmm3 https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appGtkmm3 https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
