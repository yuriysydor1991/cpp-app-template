...
- `appBoostBeast` branch at [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appBoostBeast), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appBoostBeast)] (**current**) the template infrastructure for the Web application fast start development with the [Boost Beast](https://www.boost.org/libs/beast) HTTP server.
...
1. [Requirements](/doc/sections/en_US/3-requirements/3-requirements.md)
    ...
    1. [Required package for Boost.Beast](/doc/sections/en_US/3-requirements/3-11-required-package-for-Boost.Beast.md)
...
1. [Project build](/doc/sections/en_US/5-project-build/5-project-build.md)
    ...
    1. Security / Cryptography
        ...
        1. [The HTTP server hardening constraints](/doc/sections/en_US/5-project-build/security/5-50-the-HTTP-server-hardening-constraints.md)
    1. Compression
