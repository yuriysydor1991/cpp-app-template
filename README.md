...
```
git clone --branch appMongoDBCpp4 https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appMongoDBCpp4 https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
...
In order to make the MongoDB connection library available for the template project compilation install it with a next command (GNU/Linux based OS):
...
flatpak run ua.org.kytok.template.mongodbcpp4.CppAppTemplate
```
