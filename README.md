...
- `appCURL` branch at [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appCURL), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appCURL)] (**current**) the template infrastructure to fast start the application development with the [CURL](https://en.wikipedia.org/wiki/CURL) multi protocol client library (including the HTTP) to download data from the network.
...
```
git clone --branch appCURL https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appCURL https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
