...
```
git clone --branch appWt4 https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appWt4 https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
