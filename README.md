...
- `appWt4` branch at [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appWt4), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appWt4)] (**current**) the template infrastructure to fast start Web application developing based on the [Wt C++](https://www.webtoolkit.eu/wt) full stack framework.
...
1. [Requirements](/doc/sections/en_US/3-requirements/3-requirements.md)
    ...
    1. [Required Wt packages](/doc/sections/en_US/3-requirements/3-11-required-Wt-packages.md)
        1. [Cloning and building from sources](/doc/sections/en_US/3-requirements/3-11-1-cloning-and-building-from-sources.md)
        1. [Installing via the command line](/doc/sections/en_US/3-requirements/3-11-2-installing-via-the-command-line.md)
        1. [Packages required to build the Wt](/doc/sections/en_US/3-requirements/3-11-3-packages-required-to-build-the-Wt.md)
    ...
    1. [Optional for the AppImage packager](/doc/sections/en_US/3-requirements/3-12-optional-for-the-AppImage-packager.md)
...
1. [Project build](/doc/sections/en_US/5-project-build/5-project-build.md)
    ...
    1. Containers & CI
        ...
        1. [The GitLab CI/CD pipeline](/doc/sections/en_US/5-project-build/containers-ci/5-48-the-GitLab-CI-pipeline.md)
    1. Packagers
