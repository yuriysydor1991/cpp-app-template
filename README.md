...
```
git clone --branch appFreeGlut https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appFreeGlut https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
