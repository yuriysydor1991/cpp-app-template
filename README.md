...
```
git clone --branch appMeson https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appMeson https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
