...
```
git clone --branch appGtkmm4 https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appGtkmm4 https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
