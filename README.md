...
```
git clone --branch appMySQLCppConn https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appMySQLCppConn https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
...
flatpak run ua.org.kytok.template.mysqlcppconn.CppAppTemplate
```
