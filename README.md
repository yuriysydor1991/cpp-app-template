...
- `appGtkmm3` branch at [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appGtkmm3), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appGtkmm3)] (**current**) for the application general classes with additional defined structure for the [Gtkmm](https://gtkmm.gnome.org/en/index.html)-3.0 with C++ window application development.
...
1. [Project structure](/doc/sections/en_US/4-project-structure/4-project-structure.md)
    ...
    1. [Resource embedding](/doc/sections/en_US/4-project-structure/4-6-gtkmm-resource-embedding.md)
