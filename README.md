...
1. [Requirements](/doc/sections/en_US/3-requirements/3-requirements.md)
    ...
    1. [Required packages for the log4cpp](doc/sections/en_US/3-requirements/3-11-required-packages-for-the-log4cpp.md)
...
1. [Project build](/doc/sections/en_US/5-project-build/5-project-build.md)
    ...
    1. Libraries
        1. [Enabling the log4cpp library](/doc/sections/en_US/5-project-build/5-37-enabling-the-log4cpp-library.md)
