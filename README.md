...
```
git clone --branch appPgSQLxx https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appPgSQLxx https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
