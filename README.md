...
```
git clone --branch appBoostBeast https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appBoostBeast https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
