...
```
git clone --branch appLog4Cpp5 https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appLog4Cpp5 https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
