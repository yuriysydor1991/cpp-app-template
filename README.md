...
```
git clone --branch appSQLiteCpp3 https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appSQLiteCpp3 https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
...
flatpak run ua.org.kytok.template.sqlite3cpp.CppAppTemplate
```
