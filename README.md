...
- `appMatPlotxx` branch at [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appMatPlotxx), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appMatPlotxx)] (**current**) the template infrastructure to fast start application development with the [MatPlot++](https://alandefreitas.github.io/matplotplusplus/) usage - a nice plot library with required [gnuplot](http://www.gnuplot.info/) application and [Qt6](https://www.qt.io/development/qt-framework/qt6).
...
1. [Requirements](/doc/sections/en_US/3-requirements/3-requirements.md)
    ...
    1. [Required source for the MatPlot++ project](/doc/sections/en_US/3-requirements/3-11-required-source-for-the-MatPlotxx-project.md)
