...
# The sound packs are the point of this branch and the player is the smallest
# thing able to prove they really sound, so the audio subsystem of SDL2 is
# taken and nothing else of it: no window, no renderer and no OpenGL.
...
# SDL2 itself decodes the RIFF/WAVE files alone, while OpenGameArt hosts it's
# submissions as .ogg and .mp3 alike, so the decoders of the SDL_mixer
# satellite library are what makes those audible at all.
#
