...
set(FLATPAK_PROJECT_URL ua.org.kytok.template.firebird.${PROJECT_BINARY_NAME})
...
execute_process(
  COMMAND ${FLATPAK_EXEC} --default-arch
  OUTPUT_VARIABLE FLATPAK_TARGET_ARCH
  OUTPUT_STRIP_TRAILING_WHITESPACE
)

set(FLATPAK_REPO ${PROJECT_BINARY_NAME}-repo)
set(FLATPAK_DST_NAME ${PROJECT_BINARY_NAME}-${CMAKE_PROJECT_VERSION}-${FLATPAK_TARGET_ARCH}.flatpak)
...
add_custom_target(
  ...
  COMMAND 
    ...
    ${FLATPAKB_EXEC} --user --install-deps-from=${FLATPAK_DEPS_REMOTE} --assumeyes
      --force-clean --repo=${FLATPAK_REPO} "${CMAKE_BINARY_DIR}/flatpak-build" ${flatpakConfDst} &&
