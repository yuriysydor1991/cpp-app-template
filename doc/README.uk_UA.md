...
- гілка `appWinUI3` розміщена на [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appWinUI3), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appWinUI3)] (**поточна**) яка містить загальні класи для генерації бінарного виконуваного файлу разом з структурою заданою для розробки настільної програми Microsoft Windows на базі [Microsoft WinUI 3](https://learn.microsoft.com/windows/apps/winui/winui3/) + [C++/WinRT](https://learn.microsoft.com/windows/uwp/cpp-and-winrt-apis/). Це гілка **лише для Windows**: пакувальники GNU/Linux (flatpak, snap, deb, rpm, FreeBSD pkg), інтеграцію з Docker та профайлери Valgrind/gprof було вилучено, пакувальник WIX (MSI) залишено, а конвеєр Jenkins розрахований на агента Windows. Платформонезалежне ядро досі збирається і тестується на будь-якій платформі.
...
- гілка `appOpenGameArtAudio` розміщена на [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appOpenGameArtAudio), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appOpenGameArtAudio)] яка містить загальні класи для генерації бінарного виконуваного файлу, що тримає дібрані набори звуків [OpenGameArt](https://opengameart.org) завантаженими та недоторканими, фіксує ліцензію кожного набору у маніфесті, який потрапляє до двійкового файлу, робить кожен звук кожного набору доступним з коду C++ та записує маніфести Qt ([.qrc](https://doc.qt.io/qt-6/resources.html)) і Gtkmm ([GResource](https://docs.gtk.org/gio/struct.Resource.html)), які вбудовують обрані звуки у двійковий файл програми.

- гілка `appFreesoundAudio` розміщена на [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appFreesoundAudio), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appFreesoundAudio)] яка містить загальні класи для генерації бінарного виконуваного файлу, що тримає дібрані звуки [Freesound](https://freesound.org) завантаженими та недоторканими, фіксує ліцензію і сторінку-джерело кожного окремого звуку у маніфесті, який потрапляє до двійкового файлу, робить кожен звук доступним з коду C++ та записує маніфести Qt ([.qrc](https://doc.qt.io/qt-6/resources.html)) і Gtkmm ([GResource](https://docs.gtk.org/gio/struct.Resource.html)), які вбудовують обрані звуки у двійковий файл програми.
...
1. [Структура проекту](/doc/sections/uk_UA/4-project-structure/4-project-structure.md)
    ...
    1. [Інтеграція WinUI 3 + C++/WinRT](/doc/sections/uk_UA/4-project-structure/4-8-winui3-cppwinrt-integration.md)
    ...
    1. [Впровадження нових параметрів командного рядка](/doc/sections/uk_UA/4-project-structure/4-6-introduction-of-the-custom-command-line-parameters.md)
    1. [Реалізація власних нащадків IApplication](/doc/sections/uk_UA/4-project-structure/4-7-implementing-your-onw-IApplication-descendants.md)
    1. [Обробка сигналів операційної системи](/doc/sections/uk_UA/4-project-structure/4-8-handling-the-OS-signals.md)
...
1. [Побудова проекту](/doc/sections/uk_UA/5-project-build/5-project-build.md)
    ...
    1. Контейнери та CI
        1. [Конвеєр CI GitHub Actions](/doc/sections/uk_UA/5-project-build/containers-ci/5-41-the-GitHub-Actions-CI-pipeline.md)
        1. [Конвеєр CI/CD GitLab](/doc/sections/uk_UA/5-project-build/containers-ci/5-42-the-GitLab-CI-pipeline.md)
    1. Пакувальники
    ...
    1. Безпека / Криптографія
        ...
        1. [Параметри захисту бінарних файлів](/doc/sections/uk_UA/5-project-build/security/5-49-the-binary-hardening-options.md)
    1. Стиснення даних
