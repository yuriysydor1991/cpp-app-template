...
- гілка `appMongoDBCpp4` розміщена на [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appMongoDBCpp4), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appMongoDBCpp4)] (**поточна**) котра містить інфраструктуру для швидкого старту розробки застосунку з використанням NoSQL СУБД [MongoDB](https://en.wikipedia.org/wiki/MongoDB)
...
1. [Вимоги](/doc/sections/uk_UA/3-requirements/3-requirements.md)
    ...
    1. [Обов'язкові пакети для підлкючення до MongoDB](/doc/sections/uk_UA/3-requirements/3-11-required-packages-for-the-MongoDB-connection.md)
...
1. [Побудова проекту](/doc/sections/uk_UA/5-project-build/5-project-build.md)
    ...
    1. Бібліотеки
        1. [Вмикання інтеграції драйвера MongoDB для C++](/doc/sections/uk_UA/5-project-build/5-37-enabling-the-mongocxx-library.md)
