...
- гілка `appWt4` розміщена на [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appWt4), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appWt4)] (**поточна**) шаблон з інфраструктурою для швидкого старту реалізації Web-програми на основі [Wt C++](https://www.webtoolkit.eu/wt) фулстек фреймворку.
...
1. [Вимоги](/doc/sections/uk_UA/3-requirements/3-requirements.md)
    ...
    1. [Обов'язкові пакунки для Wt](/doc/sections/uk_UA/3-requirements/3-11-required-Wt-packages.md)
        1. [Клонування і будування з вихідного джерельного коду](/doc/sections/uk_UA/3-requirements/3-11-1-cloning-and-building-from-sources.md)
        1. [Встановлення за допомогою пакетного менеджера](/doc/sections/uk_UA/3-requirements/3-11-2-installing-via-the-command-line.md)
        1. [Пакети необхідні для побудови Wt](/doc/sections/uk_UA/3-requirements/3-11-3-packages-required-to-build-the-Wt.md)
    ...
    1. [Необов'язкові програми для генерації пакунку AppImage](/doc/sections/uk_UA/3-requirements/3-12-optional-for-the-AppImage-packager.md)
...
1. [Побудова проекту](/doc/sections/uk_UA/5-project-build/5-project-build.md)
    ...
    1. Контейнери та CI
        ...
        1. [Конвеєр CI/CD GitLab](/doc/sections/uk_UA/5-project-build/containers-ci/5-48-the-GitLab-CI-pipeline.md)
    1. Пакувальники
