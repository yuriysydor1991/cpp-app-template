...
1. [Структура проекту](/doc/sections/uk_UA/4-project-structure.md)
    ...
    1. [Публічні інтерфейсні файли бібліотеки](/doc/sections/en_US/4-8-the-librarys-installable-include-header-files.md)
...
1. [Запуск головного виконуваного файлу](/doc/sections/uk_UA/6-run-avaialble-executables.md)
    1. Запуск тестів
