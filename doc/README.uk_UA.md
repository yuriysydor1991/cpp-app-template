...
- гілка `master` розміщена за адресою [головна сторінка проеку](https://github.com/yuriysydor1991/cpp-app-template) (**поточна**) яка містить загальні класи для генераці одинарного бінарного виконуваного файлу.
