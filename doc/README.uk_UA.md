...
- гілка `appGtkmm4Vulkan` розміщена на [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appGtkmm4Vulkan), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appGtkmm4Vulkan)] яка містить загальні класи для генераці одинарного бінарного виконуваного файлу, що створює інстанс [Vulkan](https://www.vulkan.org/) через сирий завантажувач Vulkan, перелічує доступні фізичні пристрої (відеокарти) та виводить їхні властивості через журнал програми, після чого показує порожнє чорне вікно [Gtkmm-4](https://gtkmm.gnome.org/en/index.html) (з чорним тлом, застосованим через вбудований CSS-ресурс, оскільки GTK4 не надає віджета для рендерингу Vulkan) протягом роботи головного циклу GTK (відповідник на базі Gtkmm-4 гілки appVulkan, що побудована на гілці app).
...
1. [Структура проекту](/doc/sections/uk_UA/4-project-structure.md)
    ...
    1. [Інтеграція Cocoa (AppKit) + Objective-C++](/doc/sections/uk_UA/4-8-cocoa-objcpp-integration.md)
