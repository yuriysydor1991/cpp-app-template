...
- гілка `appBoostBeast` розміщена на [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appBoostBeast), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appBoostBeast)] (**поточна**) котра містить інфраструктуру для швидкого старту розробки Web-програми з використанням швидкого HTTP сервера [Beast](https://www.boost.org/libs/beast) від Boost.
...
1. [Вимоги](/doc/sections/uk_UA/3-requirements/3-requirements.md)
    ...
    1. [Обов'язкові пакети для Boost.Beast](/doc/sections/uk_UA/3-requirements/3-11-required-package-for-Boost.Beast.md)
...
1. [Побудова проекту](/doc/sections/uk_UA/5-project-build/5-project-build.md)
    ...
    1. Безпека / Криптографія
        ...
        1. [Обмеження захисту HTTP-сервера](/doc/sections/uk_UA/5-project-build/security/5-50-the-HTTP-server-hardening-constraints.md)
    1. Стиснення даних
