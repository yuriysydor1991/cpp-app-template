...
1. [Структура проекту](/doc/sections/uk_UA/4-project-structure.md)
    ...
    1. [Публічні інтерфейсні файли бібліотеки](/doc/sections/uk_UA/4-9-the-librarys-installable-include-header-files.md)
...
1. [Побудова проекту](/doc/sections/uk_UA/5-project-build.md)
    ...
    1. [Налаштування складових імені встановлюваної бібліотеки](/doc/sections/uk_UA/5-23-customizing-library-name-segments.md)
