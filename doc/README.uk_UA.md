...
- гілка `appBoostLog` розміщена за адресою [appBoostLog](https://github.com/yuriysydor1991/cpp-app-template/tree/appBoostLog) (**поточна**) котра містить інфраструктуру для швидкого старту розробки застосунку з використанням бібліотеки логування повідомлень [Boost.Log](https://www.boost.org/doc/libs/latest/libs/log/doc/html/index.html)
