...
1. [Структура проекту](/doc/sections/uk_UA/4-project-structure.md)
    ...
    1. [Реалізування UI](/doc/sections/uk_UA/4-8-gtkmm3glade-ui-implementation.md)
    1. [Компіляція ресурсів](/doc/sections/uk_UA/4-6-gtkmm3glade-resource-embedding.md)
