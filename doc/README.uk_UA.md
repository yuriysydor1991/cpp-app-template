...
- гілка `app` розміщена за адресою [applib](https://github.com/yuriysydor1991/cpp-app-template/tree/app) яка містить загальні інфраструктурні класи програми для генераці одинарного бінарного виконуваного файлу.
