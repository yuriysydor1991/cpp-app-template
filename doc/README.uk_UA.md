...
- гілка `appGtkmm4Libadwaita` розміщена на [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appGtkmm4Libadwaita), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appGtkmm4Libadwaita)] (**поточна**) із загальними класами програми для генерації єдиного виконуваного бінарного файлу, усе головне вікно якого побудоване з віджетів бібліотеки [libadwaita](https://gnome.pages.gitlab.gnome.org/libadwaita/) - `AdwApplicationWindow` з `AdwToolbarView`, `AdwHeaderBar` і розміщеним зверху заголовком з описом над логотипом, що заповнює усю вільну висоту - поряд з прив'язкою C++ [Gtkmm-4](https://gtkmm.gnome.org/en/index.html).
...
1. [Структура проекту](/doc/sections/uk_UA/4-project-structure/4-project-structure.md)
    ...
    1. [Компіляція ресурсів](/doc/sections/uk_UA/4-project-structure/4-6-gtkmm4-resource-embedding.md)
    1. [Головне вікно на основі libadwaita](/doc/sections/uk_UA/4-project-structure/4-8-the-libadwaita-main-window.md)
    ...
    1. [Повідомлення інструментарію](/doc/sections/uk_UA/4-project-structure/4-9-the-toolkit-messages.md)
