...
Деякі або усі поля примірника класу `ApplicationContext` можуть переноситися у примірник класу `LibraryContext` за допомогою примірника класу перетворювача `ApplicationContext2LibraryContext` під час виклику `LibMain` за умовчанням.
