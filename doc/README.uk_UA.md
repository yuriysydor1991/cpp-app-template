...
- гілка `appMongoDBCpp4` розміщена за адресою [appMongoDBCpp4](https://github.com/yuriysydor1991/cpp-app-template/tree/appMySQLCppConn) (**поточна**) котра містить інфраструктуру для швидкого старту розробки застосунку з використанням NoSQL СУБД [MongoDB](https://en.wikipedia.org/wiki/MongoDB)
