...
- гілка `appCocoa` розміщена на [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appCocoa), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appCocoa)] (**поточна**) яка містить загальні класи для генерації бінарного виконуваного файлу разом з структурою заданою для розробки нативної настільної програми macOS на базі [Cocoa](https://developer.apple.com/documentation/appkit) / AppKit мовою [Objective-C++](https://en.wikipedia.org/wiki/Objective-C%2B%2B). Це гілка **лише для macOS**: пакувальники GNU/Linux (flatpak, snap, deb, rpm, FreeBSD pkg), пакувальник Windows WIX (MSI), інтеграцію з Docker та профайлери Valgrind/gprof було вилучено, додано пакування macOS .dmg/.pkg, а конвеєр Jenkins розрахований на агента macOS. Платформонезалежне ядро досі збирається і тестується на будь-якій платформі.
...
1. [Структура проекту](/doc/sections/uk_UA/4-project-structure/4-project-structure.md)
    ...
    1. [Інтеграція Cocoa (AppKit) + Objective-C++](/doc/sections/uk_UA/4-project-structure/4-8-cocoa-objcpp-integration.md)
