...
- гілка `appMySQLCppConn` розміщена на [[GitHub](https://github.com/yuriysydor1991/cpp-app-template/tree/appMySQLCppConn), [GitLab](https://gitlab.com/yuriysydor1991/cpp-app-template/tree/appMySQLCppConn)] (**поточна**) котра містить інфраструктуру для швидкого старту розробки застосунку з використанням СУБД [MySQL](https://uk.wikipedia.org/wiki/MySQL)
...
1. [Вимоги](/doc/sections/uk_UA/3-requirements/3-requirements.md)
    ...
    1. [Обов'язкові пакети для підключення до MySQL](/doc/sections/uk_UA/3-requirements/3-11-required-packages-for-the-MySQL.md)
