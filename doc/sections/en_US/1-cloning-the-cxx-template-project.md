...
```
git clone --branch appWinUI3 https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appWinUI3 https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
