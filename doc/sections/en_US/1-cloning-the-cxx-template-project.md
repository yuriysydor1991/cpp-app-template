...
```
git clone --branch appCocoa https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appCocoa https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
