...
```
git clone --branch appwxWidgets https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appwxWidgets https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
