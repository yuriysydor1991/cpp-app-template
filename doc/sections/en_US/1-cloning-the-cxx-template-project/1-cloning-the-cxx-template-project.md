...
```
git clone --branch appLibOAI https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appLibOAI https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
