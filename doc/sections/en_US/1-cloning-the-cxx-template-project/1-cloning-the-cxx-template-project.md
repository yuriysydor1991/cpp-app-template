...
```
git clone --branch appCURLClaude https://github.com/yuriysydor1991/cpp-app-template.git
```

or 

```
git clone --branch appCURLClaude https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
