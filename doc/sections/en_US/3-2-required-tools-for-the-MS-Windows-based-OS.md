...
- The Windows App SDK (WinUI 3) - installed through the Visual Studio installer or restored as the `Microsoft.WindowsAppSDK` NuGet package; see the [WinUI 3 + C++/WinRT integration](/doc/sections/en_US/4-8-winui3-cppwinrt-integration.md) section
