...
Replace the `runtime/org.kde.Platform/x86_64/6.8` and `runtime/org.kde.Sdk/x86_64/6.8` with your preferred SDK and platform. Consult the flatpak documentation on how to list all available options.
