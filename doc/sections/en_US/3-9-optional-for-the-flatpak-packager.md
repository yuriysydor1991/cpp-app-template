...
Replace the `org.gnome.Platform/x86_64/48 org.gnome.Sdk/x86_64/48` with your preferred SDK. Consult the flatpak documentation on how to list all available options.
