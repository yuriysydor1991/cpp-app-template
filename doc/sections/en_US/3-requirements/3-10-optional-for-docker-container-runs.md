...
Details at the section [Enabling the Docker container build and run](/doc/sections/en_US/5-project-build/containers-ci/5-12-enabling-the-docker-container-build-and-run.md).
