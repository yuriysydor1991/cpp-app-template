...
Replace the `org.gnome.Platform/x86_64/49 org.gnome.Sdk/x86_64/49` with your preferred runtime and SDK. Consult the flatpak documentation on how to list all available options.
