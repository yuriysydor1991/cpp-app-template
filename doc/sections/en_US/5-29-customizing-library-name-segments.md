...
`include/CppAppTemplate-0.12.0-dev/` next to `include/CppAppTemplate-0/`.
...
| `-DLIB_INCLUDE_MINOR_IN_NAME=true -DLIB_INCLUDE_MICRO_IN_NAME=true` | `CppAppTemplate-0.12.0` |
| `-DLIB_NAME_SUFFIX='-dev'` | `CppAppTemplate-0-dev` |
| `-DLIB_INCLUDE_MINOR_IN_NAME=true -DLIB_INCLUDE_MICRO_IN_NAME=true -DLIB_NAME_SUFFIX='-dev'` | `CppAppTemplate-0.12.0-dev` |
