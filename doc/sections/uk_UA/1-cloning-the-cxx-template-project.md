...
```
git clone --branch appSDL3 https://github.com/yuriysydor1991/cpp-app-template.git
...
```
git clone --branch appSDL3 https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
