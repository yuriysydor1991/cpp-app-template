...
```
git clone --branch appFirebird https://github.com/yuriysydor1991/cpp-app-template.git
...
```
git clone --branch appFirebird https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
