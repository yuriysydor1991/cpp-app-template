...
```
git clone --branch appCURLChatGPT https://github.com/yuriysydor1991/cpp-app-template.git
...
```
git clone --branch appCURLChatGPT https://gitlab.com/yuriysydor1991/cpp-app-template.git
```
