...
```
flatpak install runtime/org.kde.Platform/x86_64/6.8 runtime/org.kde.Sdk/x86_64/6.8
```

Необіхдно замінити `runtime/org.kde.Platform/x86_64/6.8` і `runtime/org.kde.Sdk/x86_64/6.8` власним варіантом обраного SDK і середовища. У документації до flatpak можна визначити як переглянути усі доступні варіанти.
