...
Біль детально у секції [Вмикання цілі динамічної перевірки пам'яті Valgrind](/doc/sections/uk_UA/5-project-build/code-quality/5-9-enabling-the-dynamic-memory-check-target-with-valgrind.md).