...
Необіхдно замінити `org.gnome.Platform/x86_64/49 org.gnome.Sdk/x86_64/49` власним варіантом обраного SDK. У документації до flatpak можна визначити як переглянути усі доступні варіанти.
