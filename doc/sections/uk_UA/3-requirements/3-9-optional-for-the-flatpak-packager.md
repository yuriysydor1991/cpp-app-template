...
```
flatpak install runtime/org.kde.Platform/x86_64/5.15-25.08 runtime/org.kde.Sdk/x86_64/5.15-25.08
```

Необіхдно замінити `runtime/org.kde.Platform/x86_64/5.15-25.08` і `runtime/org.kde.Sdk/x86_64/5.15-25.08` власним варіантом обраного SDK і середовища. У документації до flatpak можна визначити як переглянути усі доступні варіанти.
