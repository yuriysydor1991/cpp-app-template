...
```
flatpak install runtime/org.kde.Platform/x86_64/6.10 runtime/org.kde.Sdk/x86_64/6.10
```

Необіхдно замінити `runtime/org.kde.Platform/x86_64/6.10` і `runtime/org.kde.Sdk/x86_64/6.10` власним варіантом обраного SDK і середовища. У документації до flatpak можна визначити як переглянути усі доступні варіанти.
