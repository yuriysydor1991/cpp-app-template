...
і доступне як Meson-змінна `PROJECT_LIBRARY_NAME`, яку використовує решта системи побудови. Головний бінарник застосунку (`PROJECT_NAME`) не залежить від цих опцій та продовжує встановлюватись у стандартну директорію `bin/`.
