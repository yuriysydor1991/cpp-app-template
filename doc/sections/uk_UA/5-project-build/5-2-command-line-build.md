...
Яка у свою чергу створить директорію `build` (директорія вже додана до файлу `.gitignore`), конфігурує проект використовуючи доступну у ОС версію системи побудови CMake (детальніше у секції [Вимоги](/doc/sections/uk_UA/3-requirements/3-requirements.md) даного документу), і на кінець, будує усі цілі доступні у проекті-шаблоні.
