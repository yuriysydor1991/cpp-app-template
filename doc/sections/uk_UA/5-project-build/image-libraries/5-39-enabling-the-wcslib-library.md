...
Метод `app::Application::run` з файлу [src/app/applications/Application.cpp](/src/app/applications/Application.cpp) записує зображення у тангенціальній проекції, зчитує його заголовок назад і перетворює опорний піксель на небесні координати, тому заміни його тіло власним кодом обробки координат.
