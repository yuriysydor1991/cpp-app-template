...
Згенерований пакет повинен згенеруватись всередині кореня директорії побудови проекту. Наприклад, якщо ім'я проекту було не зміненим і його версія 0.9.0 тоді назва пакету може виглядати наступним чином: `CppAppTemplate-0.9.0-Linux.deb`.
