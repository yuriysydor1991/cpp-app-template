...
class ApplicationContext
{
 public:
  ...
  /// @brief The http address value.
  const std::string& get_http_address() const;

  /// @brief Sets the the http address value.
  void set_http_address(const std::string& newValue);

  /// @brief The http port value.
  unsigned short get_http_port() const;

  /// @brief Sets the the http port value.
  void set_http_port(const unsigned short newValue);
