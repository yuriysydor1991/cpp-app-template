...
class ApplicationContext
{
 public:
  ...
  const std::string& get_mysql_dbname() const;

  /// @brief Sets the MySQL database name.
  void set_mysql_dbname(const std::string& newValue);

  /// @brief MySQL user name.
  const std::string& get_mysql_user() const;

  /// @brief Sets the MySQL user name.
  void set_mysql_user(const std::string& newValue);

  /// @brief MySQL user password.
  const std::string& get_mysql_password() const;

  /// @brief Sets the MySQL user password.
  void set_mysql_password(const std::string& newValue);

  /// @brief MySQL hostname.
  const std::string& get_mysql_host() const;

  /// @brief Sets the MySQL hostname.
  void set_mysql_host(const std::string& newValue);

  /// @brief MySQL port.
  const std::string& get_mysql_port() const;

  /// @brief Sets the MySQL port.
  void set_mysql_port(const std::string& newValue);
  ...
  /// @brief Sets the the MySQL connection interface object. Connected in
