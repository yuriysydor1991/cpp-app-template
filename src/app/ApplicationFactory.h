...
public:
  ...
  /**
   * @brief Creates the default context to pass to the application creation routine and/or
   * to the created IApplication's instance run method.
   * 
   ...
   * 
   * @param ctx A filled ApplicationContext instance to check which application to create.
   * 
