...
{
 public:
  using LibraryFacade = CppAppTemplate011::LibraryFacade;
  ...
  {
    CppAppTemplate011::LibraryFacade::resetMocks();
  }
...
TEST_F(UTEST_Application, normal_exit)
{
  ...
  EXPECT_CALL(*CppAppTemplate011::LibraryFacade::create_library_context_mock,
              Call())
      .Times(1)
      .WillOnce(Return(ctxInstance));

  EXPECT_CALL(*CppAppTemplate011::LibraryFacade::create_library_mock, Call(_))
      .Times(1)
