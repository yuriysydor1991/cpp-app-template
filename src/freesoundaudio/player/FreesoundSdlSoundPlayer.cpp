...
FreesoundSdlSoundPlayer::FreesoundSdlSoundPlayer()
{
...
bool FreesoundSdlSoundPlayer::supports(const std::string& extension) const
{
  return extension == SUPPORTED_EXTENSION;
}

bool FreesoundSdlSoundPlayer::play(const FreesoundSoundPtr& sound)
{
...
IFreesoundSoundPlayerPtr FreesoundSdlSoundPlayer::create()
{
  return std::make_shared<FreesoundSdlSoundPlayer>();
}
