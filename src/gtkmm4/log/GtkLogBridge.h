#ifndef YOUR_CPP_APP_TEMPLATE_PROJECT_GTKMM4_GTKLOGBRIDGE_CLASS_H
#define YOUR_CPP_APP_TEMPLATE_PROJECT_GTKMM4_GTKLOGBRIDGE_CLASS_H
 ...
 */
namespace Gtkmm4i::gtklog
{

/**
 * @brief Puts every message the toolkit reports into the application log.
 *
 * GTK, GDK, GSK, GIO, Pango, gtkmm and GLib itself report through the GLib
...
#endif  // YOUR_CPP_APP_TEMPLATE_PROJECT_GTKMM4_GTKLOGBRIDGE_CLASS_H
