...
class CTEST_KenneySoundPlayer : public Test
{
 public:
  ...
  IKenneySoundPlayerPtr player{KenneySdlSoundPlayer::create()};
...
TEST_F(CTEST_KenneySoundPlayer, the_bare_sdl2_covers_the_wave_files_alone)
{
...
TEST_F(CTEST_KenneySoundPlayer, a_format_the_backend_misses_is_refused)
{
