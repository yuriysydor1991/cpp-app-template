 ...
 */
class IOpenGameArtSoundsController
{
 public:
  using IOpenGameArtSoundsControllerPtr =
      std::shared_ptr<IOpenGameArtSoundsController>;

  virtual ~IOpenGameArtSoundsController() = default;
   ...
   */
  virtual OpenGameArtSoundPtr draw() = 0;
...
using IOpenGameArtSoundsControllerPtr =
    IOpenGameArtSoundsController::IOpenGameArtSoundsControllerPtr;
