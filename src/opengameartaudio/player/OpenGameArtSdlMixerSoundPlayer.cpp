...
OpenGameArtSdlMixerSoundPlayer::OpenGameArtSdlMixerSoundPlayer()
{
...
bool OpenGameArtSdlMixerSoundPlayer::supports(
...
bool OpenGameArtSdlMixerSoundPlayer::play(const OpenGameArtSoundPtr& sound)
{
...
IOpenGameArtSoundPlayerPtr OpenGameArtSdlMixerSoundPlayer::create()
{
  return std::make_shared<OpenGameArtSdlMixerSoundPlayer>();
}
