#ifndef YOUR_CPP_APP_TEMPLATE_PROJECT_IOPENGAMEARTSOUNDS_CLASS_H
#define YOUR_CPP_APP_TEMPLATE_PROJECT_IOPENGAMEARTSOUNDS_CLASS_H
...
/**
 * @brief The whole sound set of the OpenGameArt packs the project has been
 * configured with.
 *
 ...
 * hand.
 */
class IOpenGameArtSounds
{
 public:
  using IOpenGameArtSoundsPtr = std::shared_ptr<IOpenGameArtSounds>;
  using SoundsList = std::vector<OpenGameArtSoundPtr>;

  virtual ~IOpenGameArtSounds() = default;
   ...
   */
  virtual OpenGameArtSoundPtr find(const std::string& packName,
...
using IOpenGameArtSoundsPtr = IOpenGameArtSounds::IOpenGameArtSoundsPtr;

}  // namespace opengameartaudio

#endif  // YOUR_CPP_APP_TEMPLATE_PROJECT_IOPENGAMEARTSOUNDS_CLASS_H
